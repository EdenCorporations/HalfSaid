...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-glow-soft hover:bg-primary/90 hover:shadow-glow',
      ...
      size: {
        // Defaults meet the 44px WCAG minimum touch target (SPEC §13).
        default: 'min-h-touch min-w-touch px-4 py-2',
        sm: 'min-h-touch rounded-md px-3',
        lg: 'min-h-touch rounded-md px-8 text-base',
